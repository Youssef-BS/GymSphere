 ...
 */
final class Version20240420224206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repondre CHANGE idreclamation idreclamation INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appartient (id INT AUTO_INCREMENT NOT NULL, idUser INT NOT NULL, idGym INT NOT NULL, idAbonnement INT NOT NULL, INDEX idUser (idUser), INDEX idAbonnement (idAbonnement), INDEX idGym (idGym), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE repondre CHANGE idreclamation idreclamation INT NOT NULL');
