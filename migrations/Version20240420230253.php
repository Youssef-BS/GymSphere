 ...
 */
final class Version20240420230253 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appartient (id INT AUTO_INCREMENT NOT NULL, idUser INT NOT NULL, idGym INT NOT NULL, idAbonnement INT NOT NULL, INDEX idGym (idGym), INDEX idUser (idUser), INDEX idAbonnement (idAbonnement), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = MyISAM COMMENT = \'\' ');
