 ...
 */
final class Version20240320154830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD phone_number VARCHAR(255) NOT NULL, ADD is_admin INT NOT NULL, ADD is_coach INT NOT NULL, ADD photo_profile VARCHAR(255) NOT NULL, DROP phoneNumber, DROP isAdmin, DROP isCoach, DROP photoProfile, CHANGE idUser idUser INT AUTO_INCREMENT NOT NULL, CHANGE otp otp VARCHAR(255) NOT NULL, ADD PRIMARY KEY (idUser)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD phoneNumber VARCHAR(255) NOT NULL, ADD isAdmin TINYINT(1) NOT NULL, ADD isCoach TINYINT(1) NOT NULL, ADD photoProfile VARCHAR(255) NOT NULL, DROP phone_number, DROP is_admin, DROP is_coach, DROP photo_profile, CHANGE idUser idUser INT NOT NULL, CHANGE otp otp VARCHAR(4) DEFAULT NULL');
    }
}
