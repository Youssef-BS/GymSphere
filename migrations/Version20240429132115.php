 ...
 */
final class Version20240429132115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement ADD date_debut DATE NOT NULL, ADD date_fin DATE NOT NULL, DROP dateDebut, DROP dateFin, CHANGE payment payment TINYINT(1) NOT NULL, CHANGE idAbonnement id_abonnement INT AUTO_INCREMENT NOT NULL, CHANGE idUser id_user INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE userprogram (id INT AUTO_INCREMENT NOT NULL, userId INT NOT NULL, programId INT NOT NULL, INDEX fk_userprogram_user (userId), INDEX fk_userprogram_program (programId), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('ALTER TABLE abonnement MODIFY id_abonnement INT NOT NULL');
        $this->addSql('DROP INDEX `PRIMARY` ON abonnement');
        $this->addSql('ALTER TABLE abonnement ADD dateDebut DATE NOT NULL, ADD dateFin DATE NOT NULL, DROP date_debut, DROP date_fin, CHANGE payment payment TINYINT(1) DEFAULT 0 NOT NULL, CHANGE id_abonnement idAbonnement INT AUTO_INCREMENT NOT NULL, CHANGE id_user idUser INT NOT NULL');
