...
class AbonnementController extends AbstractController
{
    ...
    #[Route ('/fetcher/{id}', name: 'fetched', methods: ['GET' , 'POST'])]

    public function fetchAbn($id, AbonnementRepository $repo): Response {
        $abn = $repo->findOneBy(['idAbonnement' => $id]);
        ...
        return $this->render('admin/component/abnDetails.html.twig', [
            "abonnement" => $abn
        ]);
    }
