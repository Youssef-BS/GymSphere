...
class ProgramController extends AbstractController
{
    ...
    public function clientPrograms(ProgramRepository $programrepository): Response
    {
...
public function payment($id, ProgramManager $programManager, ProgramRepository $programrepository): Response
{
